...
```{r}
#Fitting our model
model <- glm(win ~ FG3A + pts_allowed_log + FTA + OREB + DREB + SEASON + TO, data = final_data, family = "binomial")
summary(model)
```
...
arm::binnedplot(model_aug$pts_allowed_log, model_aug$resid, xlab = "year", col.int = NULL)
